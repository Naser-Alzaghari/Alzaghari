        ...
        <div class="flex justify-center w-full h-full my-auto xl:gap-14 lg:justify-normal md:gap-5 draggable">
            ...
            <div class="flex items-center justify-center w-full lg:p-12">
                <div class="flex items-center xl:p-10">
                    <form method="POST" action="{{ route('admin.login') }}" class="flex flex-col w-full h-full pb-6 text-center gradient-container rounded-3xl p-8">
                        @csrf
                        <h3 class="text-4xl font-extrabold text-dark-grey-900 mb-5">Admin Sign In</h3>
                        ...
                        <button class="w-full px-6 py-5 mb-5 mt-5 text-sm font-bold leading-none text-white transition duration-300 md:w-96 rounded-2xl hover:bg-purple-blue-600 focus:ring-4 focus:ring-purple-blue-100 bg-purple-blue-500">Sign In</button>
